...
func (_m *Collection) Aggregate(_a0 context.Context, _a1 interface{}) (mongodb.Cursor, error) {
	ret := _m.Called(_a0, _a1)

	var r0 mongodb.Cursor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}) (mongodb.Cursor, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, interface{}) mongodb.Cursor); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Collection) Find(_a0 context.Context, _a1 interface{}, _a2 ...*options.FindOptions) (mongodb.Cursor, error) {
	_va := make([]interface{}, len(_a2))
	for _i := range _a2 {
		_va[_i] = _a2[_i]
	}
...
func (_m *Collection) FindOne(_a0 context.Context, _a1 interface{}) mongodb.SingleResult {
	ret := _m.Called(_a0, _a1)

	var r0 mongodb.SingleResult
	if rf, ok := ret.Get(0).(func(context.Context, interface{}) mongodb.SingleResult); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
